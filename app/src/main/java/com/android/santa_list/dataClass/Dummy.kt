...
object Dummy {
    ...
    val choco = User("id6", "초코", "010-1234-5678", "choco_love@gmail.com", UserGroup.FAMILY, R.drawable.image_jaesun, is_starred = false)
    val hooon = User("id7", "훈이", "010-1234-5678", "hooon@gmail.com", UserGroup.FRIEND, R.drawable.image_jaesun, is_starred = false)
    val ddongddong = User("id8", "뚱이", "010-1234-5678", "ddongddong2@gmail.com", UserGroup.NONE, R.drawable.image_jaesun, is_starred = false)
    val chulsoooo = User("id9", "철수", "010-1234-5678", "chulsoooo@gmail.com", UserGroup.FRIEND, R.drawable.image_jaesun, is_starred = false)
    val white_dog = User("id10", "흰둥이", "010-1234-5678", "white_dog@gmail.com", UserGroup.FAMILY, R.drawable.image_jaesun, is_starred = false)
    val crayon = User("id11", "짱구", "010-1234-5678", "crayon@gmail.com", UserGroup.FRIEND, R.drawable.image_jaesun, is_starred = false)
    val sponge = User("id12", "스폰지밥", "010-1234-5678", "sponge@gmail.com", UserGroup.NONE, R.drawable.image_jaesun, is_starred = false)
    val glass = User("id13", "유리", "010-1234-5678", "glass@gmail.com", UserGroup.FRIEND, R.drawable.image_jaesun, is_starred = false)
    val thunder = User("id14", "피카츄", "010-1234-5678", "thunder@gmail.com", UserGroup.FAMILY, R.drawable.image_jaesun, is_starred = false)
